...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference("Articulo.count") do
      post articulos_url, params: { articulo: { autor: @articulo.autor, contenido: @articulo.contenido, etiquetas: @articulo.etiquetas, fecha: @articulo.fecha, genero: @articulo.genero, titulo: @articulo.titulo } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { autor: @articulo.autor, contenido: @articulo.contenido, etiquetas: @articulo.etiquetas, fecha: @articulo.fecha, genero: @articulo.genero, titulo: @articulo.titulo } }

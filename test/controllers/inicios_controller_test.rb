...
class IniciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inicio" do
    assert_difference("Inicio.count") do
      post inicios_url, params: { inicio: { direccion: @inicio.direccion, email: @inicio.email, fecha: @inicio.fecha, genero: @inicio.genero, nombre: @inicio.nombre, telefono: @inicio.telefono } }
    end
  ...
  test "should update inicio" do
    patch inicio_url(@inicio), params: { inicio: { direccion: @inicio.direccion, email: @inicio.email, fecha: @inicio.fecha, genero: @inicio.genero, nombre: @inicio.nombre, telefono: @inicio.telefono } }
